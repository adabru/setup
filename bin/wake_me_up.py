...
# copied code from playsound module, inspect e.g. with: pip install -t . playsound
...
if len(sys.argv) < 3:
  print("usage:\n\n   \033[1mwake_me_up.py\033[22m path/to/audiofolder 30\n")
  exit()
...
for i in range(minutes, 0, -1):
  print("{:} minutes to go...".format(i))
  time.sleep(60)

# play audio in loop
while True:
  for file in chosen:
    playsound(os.path.join(audiofolder, file))
